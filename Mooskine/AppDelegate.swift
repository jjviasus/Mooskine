...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // the root view of our window is the navigation controller
        let navigationController = window?.rootViewController as! UINavigationController
        // the navigation controller's top view is the notebooks list view controller
        let notebooksListViewController = navigationController.topViewController as! NotebooksListViewController
        // this will inject the data controller dependency into notebooks list view controller
